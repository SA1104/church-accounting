...
async function runMockTest() {
  ...
  const rawData = [
    { ISU_SRT_CD: '005930', ISU_ABBRV: 'Samsung', LIST_DD: '19750611', SECUGRP_NM: 'Stock' },
    { ISU_SRT_CD: '005935', ISU_ABBRV: 'SamsungP', LIST_DD: '19750611', KIND_STKCERT_TP_NM: 'Preferred' },
    { ISU_SRT_CD: '999999', ISU_ABBRV: 'BadDate', LIST_DD: '20261399' }
  ];
  ...
  if (!insts2.rows[0].listing_date) throw new Error('listing_date is null');

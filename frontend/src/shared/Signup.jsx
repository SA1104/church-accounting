            ...
            <form onSubmit={handleSignupSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2.5 pt-1">
                ...
                <label htmlFor="termsAgree" className="text-[10px] text-slate-400 leading-snug cursor-pointer select-none">
                  <span onClick={() => setShowPrivacyModal(true)} className="underline text-indigo-405 hover:text-indigo-300 font-semibold cursor-pointer">개인정보 처리방침</span> 및 <span onClick={() => setShowTermsModal(true)} className="underline text-indigo-405 hover:text-indigo-300 font-semibold cursor-pointer">BOOZA THINK 플랫폼 이용약관</span>에 동의합니다. *
                </label>
              </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="glass max-w-md w-full p-6 rounded-2xl border border-slate-800 shadow-2xl space-y-4 max-h-[85vh] flex flex-col">
            ...
            <button
              ...
              className="w-full py-2 bg-indigo-655 hover:bg-indigo-600 text-white rounded-xl text-xs font-bold transition-all active:scale-[0.98] shrink-0"
            >
              확인 및 닫기
            </button>
          </div>

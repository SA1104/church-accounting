                  ...
                  {passkeySuccess ? (
                    ...
                    <div className="flex gap-2 pt-1">
                      ...
                      <button
                        type="button"
                        onClick={() => navigate('/login')}
                        className="flex-1 bg-slate-900 hover:bg-slate-800 text-slate-400 font-semibold py-2.5 rounded-xl text-[10px] border border-slate-800 transition-all active:scale-95"
                      >
                        건너뛰기
                      </button>
                    </div>
      ...
      {showTermsModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="glass max-w-md w-full p-6 rounded-2xl border border-slate-800 shadow-2xl space-y-4 max-h-[85vh] flex flex-col">
            ...
            <div className="overflow-y-auto pr-2 text-[10px] text-slate-400 leading-relaxed space-y-3 font-sans max-h-[50vh] no-scrollbar">
